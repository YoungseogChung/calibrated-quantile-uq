...
def plot_calibration_curve(exp_proportions, obs_proportions,
                           title=None, curve_label=None, make_plots=False):
    # Set figure defaults
    width = 5
    fontsize = 12
...
def get_props(cdf_model, x_tensor, y_tensor, exp_props=None, recal_model=None,
              recal_type=None):
...
def ens_get_props(cdf_model, x_tensor, y_tensor, exp_props=None, recal_model=None,
              recal_type=None):
